...
Public project-status and product overview for **PenguTactic**, a private Teamfight Tactics data-engineering and machine-learning research project.

The landing page tracks the state of the main private repository conservatively:

- only work integrated into `main` is presented as completed;
